...
metadata:
  ...
  source_path: '~/.codex/skills/memory-forensics/SKILL.md'
...
## When to Use
- The request matches the skill description: Comprehensive techniques for acquiring, analyzing, and extracting artifacts from memory dumps for incident response and malware analysis.
