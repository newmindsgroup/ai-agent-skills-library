...
metadata:
  ...
  source_path: '~/.codex/skills/leiloeiro-avaliacao/SKILL.md'
...
## When to Use
- The request matches the skill description: Avaliacao pericial de imoveis em leilao. Valor de mercado, liquidacao forcada, ABNT NBR 14653, metodos comparativo/renda/custo, CUB e margem de seguranca.
