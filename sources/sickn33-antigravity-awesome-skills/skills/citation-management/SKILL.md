...
metadata:
  ...
  source_path: '~/.codex/skills/citation-management/SKILL.md'
...
## When to Use
- The request matches the skill description: Manage citations systematically throughout the research and writing process.
