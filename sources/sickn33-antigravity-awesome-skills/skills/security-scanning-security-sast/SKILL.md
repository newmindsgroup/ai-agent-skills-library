...
metadata:
  ...
  source_path: '~/.codex/skills/security-scanning-security-sast/SKILL.md'
...
## When to Use
- The request matches the skill description: Static Application Security Testing (SAST) for code vulnerability
