...
metadata:
  ...
  source_path: '~/.codex/skills/ui-component-patterns/SKILL.md'
...
Also read `/Users/newmindsgroup/.codex/skills/visual-style-bible/SKILL.md` when the component work depends on the house visual system.
