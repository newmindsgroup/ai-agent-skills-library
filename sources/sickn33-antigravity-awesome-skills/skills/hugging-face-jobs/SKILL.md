...
metadata:
  ...
  source_path: '~/.codex/skills/hugging-face-jobs/SKILL.md'
...
## When to Use
- The request matches the skill description: Run workloads on Hugging Face Jobs with managed CPUs, GPUs, TPUs, secrets, and Hub persistence.
