...
metadata:
  ...
  source_path: '~/.codex/skills/saga-orchestration/SKILL.md'
...
## When to Use
- The request matches the skill description: Patterns for managing distributed transactions and long-running business processes.
