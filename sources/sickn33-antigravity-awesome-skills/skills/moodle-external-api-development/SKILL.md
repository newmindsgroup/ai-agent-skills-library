...
metadata:
  ...
  source_path: '~/.codex/skills/moodle-external-api-development/SKILL.md'
...
## When to Use
- The request matches the skill description: This skill guides you through creating custom external web service APIs for Moodle LMS, following Moodle's external API framework and coding standards.
...
- Testing Your API
- Via Moodle Web Services Test Client
- Via curl
- Via JavaScript (AJAX)
