...
metadata:
  ...
  source_path: '~/.codex/skills/fp-react/SKILL.md'
...
## When to Use
- The request matches the skill description: Practical patterns for using fp-ts with React - hooks, state, forms, data fetching. Works with React 18/19, Next.js 14/15.
