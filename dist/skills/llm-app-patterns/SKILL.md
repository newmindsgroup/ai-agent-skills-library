...
metadata:
  ...
  source_path: '~/.codex/skills/llm-app-patterns/SKILL.md'
...
## When to Use
- The request matches the skill description: Production-ready patterns for building LLM applications, inspired by [Dify](https://github.com/langgenius/dify) and industry best practices.
