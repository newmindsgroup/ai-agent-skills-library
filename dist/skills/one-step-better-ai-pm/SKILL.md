...
license: MIT
metadata:
  imported_from: 'agents'
  source_repository: 'https://github.com/menkesu/awesome-pm-skills and skills CLI installs'
  source_path: '~/.agents/skills/one-step-better-ai-pm/SKILL.md'
