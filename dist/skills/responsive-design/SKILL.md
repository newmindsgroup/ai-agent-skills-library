...
metadata:
  ...
  source_path: '~/.codex/skills/responsive-design/SKILL.md'
...
Also read `/Users/newmindsgroup/.codex/skills/visual-style-bible/SKILL.md` before making stylistic responsive decisions that should match the house visual system.
