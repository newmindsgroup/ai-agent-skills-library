...
metadata:
  ...
  source_path: '~/.codex/skills/voice-ai-engine-development/SKILL.md'
...
## When to Use
- The request matches the skill description: Build real-time conversational AI voice engines using async worker pipelines, streaming transcription, LLM agents, and TTS synthesis with interrupt handling and multi-provider support
...
- Agent (Text → Response)
- Synthesizer (Text → Audio)
- Output Device (Audio → Client)
