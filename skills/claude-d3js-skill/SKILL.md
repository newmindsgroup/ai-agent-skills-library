...
metadata:
  ...
  source_path: '~/.codex/skills/claude-d3js-skill/SKILL.md'
...
## When to Use
- The request matches the skill description: This skill provides guidance for creating sophisticated, interactive data visualisations using d3.js.
