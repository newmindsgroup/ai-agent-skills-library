...
metadata:
  ...
  source_path: '~/.codex/skills/web-design-guidelines/SKILL.md'
...
Also read `/Users/newmindsgroup/.codex/skills/visual-style-bible/SKILL.md` before giving opinionated visual guidance.
