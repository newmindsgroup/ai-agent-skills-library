...
metadata:
  ...
  source_path: '~/.codex/skills/matematico-tao/SKILL.md'
...
- Análise Matemática De Código
- Análise De Concorrência E Sistemas Reativos
- Análise De Performance E Otimização
- Análise Formal De Corretude
- Teoria Das Categorias Para Arquitetura
