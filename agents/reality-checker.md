...
description: "Stops fantasy approvals, evidence-based certification - Default to \"NEEDS WORK\", requires overwhelming proof for production readiness Use PROACTIVELY before declaring any production-bound work complete — feature ready, deploy approved, release certified. Acts as the final evidence-based quality gate. Trigger on: 'ready to ship', 'production ready', 'final check', 'release approval', 'is this done', 'certify this'."
---
<!-- installed-by: agency-agents-cherry-pick | upstream-name: Reality Checker | source: testing/testing-reality-checker.md -->
