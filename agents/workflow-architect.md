...
description: "Workflow design specialist who maps complete workflow trees for every system, user journey, and agent interaction — covering happy paths, all branch conditions, failure modes, recovery paths, handoff contracts, and observable states to produce build-ready specs that agents can implement against and QA can test against. Use PROACTIVELY when the user wants to map a system end-to-end before coding, document every path through a flow, or design a new automation. Trigger on: 'map this workflow', 'every path', 'workflow design', 'before we code', 'system map', 'automation design'."
---
<!-- installed-by: agency-agents-cherry-pick | upstream-name: Workflow Architect | source: specialized/specialized-workflow-architect.md -->
