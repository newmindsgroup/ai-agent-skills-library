...
description: "Expert database specialist focusing on schema design, query optimization, indexing strategies, and performance tuning for PostgreSQL, MySQL, and modern databases like Supabase and PlanetScale. Use PROACTIVELY when the user discusses slow queries, database tuning, schema design, indexing, migration planning, or PostgreSQL/MySQL performance. Trigger on: 'slow query', 'index', 'schema', 'database performance', 'migration', 'postgres', 'mysql', 'EXPLAIN'."
---
<!-- installed-by: agency-agents-cherry-pick | upstream-name: Database Optimizer | source: engineering/engineering-database-optimizer.md -->
