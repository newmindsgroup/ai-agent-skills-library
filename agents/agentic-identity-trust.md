...
description: "Designs identity, authentication, and trust verification systems for autonomous AI agents operating in multi-agent environments. Ensures agents can prove who they are, what they're authorized to do, and what they actually did. Use PROACTIVELY when the user discusses agent authentication, multi-agent authorization, audit trails for autonomous systems, or trust boundaries between agents. Trigger on: 'agent auth', 'agent identity', 'audit trail', 'agent permissions', 'trust boundary', 'agent verification'."
---
<!-- installed-by: agency-agents-cherry-pick | upstream-name: Agentic Identity & Trust Architect | source: specialized/agentic-identity-trust.md -->
