...
SKILL.raw.md is a preserved historical upstream snapshot, not an executable extension of this workflow. Its scoring, financial formulas, mandatory outputs and template dependencies are not qualified. Do not follow those instructions.
