...
See [personalization.md](references/personalization.md) for evidence-based personalization guidance.
...
Consider a low-friction interest question when appropriate to the audience and offer; do not assume it universally outperforms a meeting request. One CTA per email. Make it easy to say yes with a one-line reply.
...
Use a brief, accurate subject that identifies the real topic. Do not imply an internal relationship, prior conversation, or existing customer relationship that does not exist.

- 2-4 words, lowercase, no punctuation tricks
- Should clearly match the message topic ("reply rates," "hiring ops," "Q2 forecast")
- No product pitches, no urgency, no emojis, no prospect's first name

See [subject-lines.md](references/subject-lines.md) for topic-relevance guidance.
...
The references contain optional drafting and measurement methods. They do not supply verified performance forecasts:

- [benchmarks.md](references/benchmarks.md), Metric definitions, evidence requirements and no-baseline planning
- [personalization.md](references/personalization.md), Evidence-based personalization guidance
