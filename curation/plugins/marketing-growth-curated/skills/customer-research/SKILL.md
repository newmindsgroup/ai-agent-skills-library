...
description: When the user wants to conduct, analyze, or synthesize customer research.
  ...
  analysis," "voice of customer," "VOC," "build personas," "customer personas," "jobs
  to be done," "JTBD," "what do customers say," "what are customers struggling with,"
  "Reddit mining," "G2 reviews," "review mining," "digital watering holes," "community
  research," "forum research," "competitor reviews," "customer sentiment," or "find
  out why customers churn/convert/buy." Use for both analyzing existing research assets
  AND gathering new research from online sources. For writing copy informed by research,
  see copywriting. For acting on research to improve pages, see page-cro.
metadata:
  version: 1.0.0
...
For each insight, record the number of independent sources, segment coverage, recruitment or selection bias, whether it was prompted, contradictory evidence, and recency. Repeated excerpts from one person count as one source. A source-count threshold alone does not establish high confidence. Describe the uncertainty and what would validate the inference.
...
**Small samples**: You may summarize supplied evidence at any sample size, clearly limiting conclusions to that sample. Treat personas as provisional and do not invent details or claim population validity from a fixed count.
...
Build personas from research rather than invented attributes. With limited or biased evidence, provide a provisional hypothesis and name the gaps. A fixed number of interviews, reviews, or posts does not establish representativeness.
...
- Company size: [e.g., "50 to 500 employees, Series A to C SaaS"]
- Industry: [if narrow]
- Reports to: [who]
...
Use the requested deliverable when it is clear. Ask only when the choice would materially change the result and has not already been answered.
