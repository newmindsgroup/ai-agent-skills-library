...
Version-Timestamp: 2026-09-15T19:03:10.058784-04:00

Use these as context-dependent suggestions, never automatic replacements. Preserve technical meaning, legal effect, factual certainty and the intended sense of a word. For example, "fabricate evidence" does not simply mean "make evidence", "demonstrate" need not mean "prove", and "outstanding work" does not mean "unpaid work". Retain a precise familiar term when a suggested substitute changes meaning.
...
| demonstrate | show; preserve the original evidential strength |
| denote | show, mean |
...
| option | choice |
| otherwise | or |
| outstanding | remaining (unfinished work); unpaid (debt); excellent (praise) |
| owing to | because |
