...
Version-Timestamp: 2026-09-15 06:46:18 AST

## Evidence and scope requirements

Use approved project facts and brand instructions. Label assumptions and fictional examples. Verify changing competitor facts against dated sources before including them in a deliverable. Missing evidence stays unknown. Do not invent performance results, testimonials, ratings or migration estimates. Deliver only the requested analysis or page. Account creation, outreach, publication and recurring monitoring require explicit authorization.
...
3. List of alternatives ordered by the stated buyer criteria, with sponsorship disclosed
4. Comparison table (summary)
5. Detailed breakdown of each alternative
6. Recommendation by use case
7. CTA

**Tone**: Transparent comparison: disclose authorship and recommend the best fit for the buyer, including a competitor when justified
...
For an explicitly requested multi-page comparison library, consider an index page that lists the pages of each type. A single-page request does not require an index. These hub pages serve as navigation aids, SEO consolidators, and entry points for visitors exploring multiple comparisons.
...
checked_at: "[Date]"
primary_use_case: "[Supported description]"
pricing: "[Verified plan, currency, billing term and date, or unknown]"
strengths: ["[Supported strength]"]
limitations: ["[Supported limitation]"]
best_for: ["[Buyer criteria supported by evidence]"]
migration: "[Verified scope and estimate, or unknown]"
```
...
1. **Product research**
   - Use an existing authorized trial when available; create an account only with explicit authorization
