...
That [delivers an outcome supported by verified product evidence]
...
Ask:
- Does evidence show meaningful barriers to competitors copying this advantage over the decision horizon?
- Does this matter to customers?
- Do we execute this better than anyone?
- Is this advantage durable?

Treat each answer as evidence to assess, not a mechanical verdict. Resistance to copying supports defensibility. An unknown answer requires further evidence. Explain the relevant time horizon and uncertainty.
...
Use the frameworks and examples in this playbook. No additional reference files are bundled.
